...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __CNTREE_SUBALLOCATOR64_CNC_HPP
#define __CNTREE_SUBALLOCATOR64_CNC_HPP
...
//     #                       C L A S S                              #      ##
//     #                                                              #      ##
//     #    B A S I C _ S U B A L L O C 6 4_ C N C < ALLOC_T ,T1 >    #      ##
//     #                                                              #      ##
//     ################################################################      ##
//                                                                           ##
//#############################################################################
...
typedef c_alloc::pool64 <  (SizeElem), true ,AllocByte>  MyPool ;
...
//
//  explicit basic_suballoc64_cnc ( void)
//  virtual ~basic_suballoc64_cnc ( void)
//-**************************************************************************
explicit basic_suballoc64_cnc ( void ) :Pila (singleton::instance()){ };
basic_suballoc64_cnc ( const Allocator &Alfa ):Pila (singleton::instance()),A(Alfa) { };
basic_suballoc64_cnc ( const basic_suballoc64_cnc  &Alfa ):Pila (singleton::instance()),A(Alfa.A) { };
...
//     #                       C L A S S                              #      ##
//     #                                                              #      ##
//     #   B A S I C _ S U B A L L O C 6 4_ C N C < ALLOC_T ,VOID >   #      ##
...
class basic_suballoc64_cnc<Allocator, void >
{
public :
//***************************************************************************
//                 P U B L I C    D E F I N I T I O N S
...
explicit basic_suballoc64_cnc ( void ) { };
basic_suballoc64_cnc ( const Allocator & ) { };
basic_suballoc64_cnc ( const basic_suballoc64_cnc  & ) { };
...
class suballocator64_cnc:
public basic_suballoc64_cnc < typename filter_suballoc<Allocator>::name ,
...
typedef basic_suballoc64_cnc < FAllocator ,value_type > mybasic_suballoc64_cnc ;

//***************************************************************************
//       C O N S T R U C T O R , D E S T R U C T O R , B I N D
//
//  explicit suballocator64_cnc();
//  suballocator64_cnc( suballocator64_cnc<Allocator> const&) ;
//
//  template<typename U>
//  suballocator64_cnc(suballocator64_cnc<U> const&) ;
//
//  virtual ~suballocator64_cnc() ;
//
//  template<typename U>
//  struct rebind
//
...
//------------------------------------------------------------------------
explicit suballocator64_cnc ( void ) { };
//------------------------------------------------------------------------
//  function : basic_suballoc64
/// @brief constructor of the class
//------------------------------------------------------------------------
suballocator64_cnc ( const Allocator &Alfa ):mybasic_suballoc64_cnc (Alfa) { };
//------------------------------------------------------------------------
//  function : basic_suballoc64
/// @brief Copy constructor
/// @param [in] Alfa : this parameter is passed to the basic_suballocator
//------------------------------------------------------------------------
suballocator64_cnc ( const suballocator64_cnc &Alfa ):mybasic_suballoc64_cnc (Alfa) { };
//------------------------------------------------------------------------
//  function : basic_suballoc64
...
{   typedef  typename FAllocator::template rebind<U>::other base_other ;
    typedef suballocator64_cnc <base_other> other;
};
...
/// @remarks
//------------------------------------------------------------------------
bool operator==(suballocator64_cnc const&)  {  return true;   };
//------------------------------------------------------------------------
//  function : operator !=
...
/// @remarks
//------------------------------------------------------------------------
bool operator!=(suballocator64_cnc const& )  { return false;  };
//------------------------------------------------------------------------
//  function : operator==
/// @brief equality operator
/// @param [in] reference to the suballocator to compare
...
//------------------------------------------------------------------------
template <typename Allocator2>
bool operator==(suballocator64_cnc<Allocator2> const&) { return true;  };
//------------------------------------------------------------------------
//  function : operator !=
/// @brief inequality operator
/// @param [in]reference to the suballocator to compare
...
//------------------------------------------------------------------------
template <typename Allocator2>
bool operator!=(suballocator64_cnc<Allocator2> const& )  { return false; };
...
{
template < typename T>
void swap ( countertree::suballocator64_cnc < T > & A ,
            countertree::suballocator64_cnc < T > & B   ){ };
};
#endif
