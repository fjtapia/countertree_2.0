...
cntree::vector_tree_cnc <uint32_t> VTC ;
using countertree::common::size_type ;

typedef cntree::vector_tree_cnc <uint32_t>::iterator vt_iterator ;
...
int InsercionBinaria ( const cntree::vector_tree_cnc<int> &A , int Valor) ;
int BusquedaBinaria ( const cntree::vector_tree_cnc<int> &A , int Valor);

void prueba1 (void)
{   //------------------------ Inicio -----------------------------
    cntree::vector_tree_cnc<int32_t> A ;
    ...
    cntree::vector_tree_cnc<int32_t> B ( A.begin(), A.end());
    ASSERT (B.check() );

    for ( int i =0  ; i < 10 ;++i)  ASSERT(B[i] == i );

    cntree::vector_tree_cnc <int32_t> C ( (signed_type)10, (int32_t)7 );
    ASSERT (C.check() );
    for ( int i =0  ; i < 10 ;++i)  ASSERT(C[i] == 7 );


    cntree::vector_tree_cnc<int32_t> D( A);
    ASSERT (D.check() );
    ...
    //-------------------------------------------------------------------
    cntree::vector_tree_cnc<int32_t> H( std::move(A));
    ASSERT (H.check() );
    ASSERT (A.check() );
    ...
    cntree::vector_tree_cnc<int32_t>::iterator PAux  ;
    for ( int32_t i = 0 ; i < 10 ; i ++ )
    ...
    cntree::vector_tree_cnc<int32_t>::reverse_iterator Alfa , Beta ;
...
void prueba2 ( void)
{   //---------------------- Variables----------------------------
    cntree::vector_tree_cnc<int> M1 , M2;
...
void prueba4 ( void)
{   //---------------------- Variables----------------------------
    cntree::vector_tree_cnc<int> M1, M2, M3 ;
       int i ;
...
void prueba5 ( void)
{   //---------------------------- begin -------------------------
    cntree::vector_tree_cnc<int>  V1, V2, V3 ;
    std::vector<int> V4 ;
