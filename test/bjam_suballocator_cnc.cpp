//----------------------------------------------------------------------------
/// @file bjam_suballocator_cnc.cpp
...
void test ( void)
{   //---------------------------- begin---------------------------
    typedef myallocator <void> S0 ;
    typedef suballocator32_cnc <S0 > S1 ;
    typedef suballocator64_cnc <S0 > S2 ;
    typedef suballocator_cnc   <S0 > S3 ;
    typedef suballocator32_cnc <S1 > S4 ;
    typedef suballocator32_cnc <S2 > S5 ;
    typedef suballocator64_cnc <S1 > S6 ;
    typedef suballocator64_cnc <S2 > S7 ;
    typedef suballocator_cnc   <S3 > S8 ;
    typedef suballocator_cnc   <S8 > S9 ;
    //------------------------------------------------------------
    //                  Invocations
    //------------------------------------------------------------
