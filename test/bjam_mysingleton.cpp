...
chapuza & glb_chapuza::ch = c_common::mysingleton <chapuza, false>::instance()  ;

static glb_chapuza &gch = c_common::mysingleton <glb_chapuza, false>::instance() ;
...
{   //---------------------- begin ---------------------
    gch.ch.N = 17 ;
    chapuza & ch1 ( c_common::mysingleton <chapuza, false>::instance());
    BOOST_CHECK ( ch1.N == 17);
    //glb_chapuza & gch1 ( c_common::mysingleton <glb_chapuza, false>::instance() );
    glb_chapuza gch1 ;
    BOOST_CHECK ( gch1.ch.N == 17);
    gch1.ch = ch1 ;
    BOOST_CHECK ( gch1.ch.N == 17);
    {   chapuza & ch2 ( c_common::mysingleton <chapuza, false>::instance());
        BOOST_CHECK ( ch1.N == 17);
        ch1 = ch2 ;
    }
    BOOST_CHECK ( ch1.N == 17);
