...
#include <set>
#include <time.h>
#define NELEM_VECTOR 2000000
#define NELEM_SET     200000
...
template <class Allocator>
void test_archiperre ( void)
{   //------------------------------ begin ----------------------------------
    archiperre ** K = new archiperre* [NELEM_VECTOR];
    typename Allocator::template rebind<archiperre >::other A;
