...
static uint32_t NELEM1(0),NELEM2 (0);
...
{   //---------------------- Variables----------------------------
    ...
    std::vector<typename S1_t::const_iterator> It(NCores);
...
{   //--------------------------------------------------------------
    ...
    cout<<"   MENU ( Select the number of elements)  \n";
    cout<<"  ======================================= \n";
    cout<<"1.- S1 ( 25 000 000 ) S2 ( 25 000 000 )-------->\n";
    cout<<"2.- S1 ( 50 000 000 ) S2 ( 10 000 000 )-------->\n";
    cout<<"3.- S1 ( 50 000 000 ) S2 (  1 000 000 )-------->\n";
    cout<<"4.- EXIT\n\n";
    cout<<"Select Option ->";
    cin>>Option ;
    switch ( Option)
    {
    case 1: cout<<"1.- S1 ( 25 000 000 ) S2 ( 25 000 000 )-------->\n";
            NELEM1 = NELEM2= 25000000 ;
            break ;

    case 2: cout<<"2.- S1 ( 50 000 000 ) S2 ( 10 000 000 )-------->\n";
            NELEM1 = 10000000;
            NELEM2 = 50000000;
            break ;

    case 3: cout<<"3.- S1 ( 50 000 000 ) S2 (  1 000 000 )-------->\n";
            NELEM1 =  1000000;
            NELEM2 = 50000000;
            break ;
