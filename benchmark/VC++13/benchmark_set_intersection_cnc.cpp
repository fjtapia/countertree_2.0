...
static const uint32_t NCores = ( NC >4)?4:NC ;
...
{   //--------------------------------------------------------------
    ...
    //--------------------------------------------------------------
    cout<<"----------------------------------------------------------------------\n";
    cout<<"This program make the intersection of two sets ( S1,S2) of elements uint32_t\n";
    cout<<"The result is on S3\n";
    cout<<" The menu permit to do with a 1 core,several cores and with the <algorithm>\n";
    cout<<" function set_intersection\n";
    cout<<"----------------------------------------------------------------------\n";
    uint32_t Option =0 ;
